...
import sejfa1 from '../images/Sejfa1.webp'
import sejfa2 from '../images/Sejfa2.webp'
import sejfa3 from '../images/Sejfa3.webp'
import sejfa4 from '../images/Sejfa4.webp'
import bookyHero from '../images/BookyHero.webp'
import booky4 from '../images/Booky4.mp4'
import booky5 from '../images/Booky5.webp'
import booky1 from '../images/Booky1.webp'
...
export default function CasePage({ slug }: CasePageProps) {
  return (
    <>
    <main className="snap-start snap-always min-h-[100svh] md:h-[100svh] md:overflow-y-auto px-4 md:px-10 pt-6 flex flex-col">
      <Link
        to="/"
