...
export default function Home() {
  return (
    <main>
      ...
      <section
        id="hero"
        className="md:snap-start md:snap-always flex flex-col md:flex-row gap-6 md:gap-8 pt-16 md:pt-[104px] pb-32 md:pb-[104px] px-4 md:px-10 min-h-[100svh] md:min-h-[calc(100svh+64px)]"
      >
